...
#include "../../src/modules/bfs_8cu.hpp"
...
void GraphProcessing::runBFS(int hardwarePECount,int numCols){
    ...
    double time_kernel=0,time_kernel1=0,time_kernel2=0,time_kernel3=0,time_kernel4=0,time_kernel5=0,time_kernel6=0,time_kernel7=0,time_kernel_levelgen=0,time_kernel_levelgen_1=0,time_kernel_remove=0,time_kernel_remove1=0;
