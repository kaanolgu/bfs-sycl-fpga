...
// ./build/fpga_bfs.emu rmat-19-32 #partitions
  ...
  unsigned int offset_inds_cpu =0;
	...
	loadMatrixCPU(1,old_buffer_size_meta_cpu,old_buffer_size_indptr_cpu,old_buffer_size_inds_cpu,old_buffer_size_config_cpu,offset_meta_cpu,offset_indptr_cpu,offset_inds_cpu);
...
h_graph_visited[start_vertex]=1; 
  ...
  int indptr_start = old_buffer_size_indptr_cpu[cpuCUnum]/4;
  int indptr_end = old_buffer_size_indptr_cpu[cpuCUnum]/4 + old_buffer_size_indptr_cpu[cpuCUnum+1]/4;
